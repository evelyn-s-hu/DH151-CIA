...
function mapCSV(data){
    ...
    // create marker
		...
		.on('mouseover', function(){
			this.bindPopup(
        `<h3>${item.city_state}</h3><p><strong>Anti Asian: </strong>${item["Anti-Asian"]}</p><p><strong>Anti-Black or African American: </strong>${item["Anti-Black or African American"]}</p><p><strong>Anti-American Indian or Alaska Native: </strong>${item["Anti-American Indian or Alaska Native"]}</p><p><strong>Anti-Multiple Races, Group: </strong>${item["Anti-Multiple Races, Group"]}</p><p><strong>Anti-Hispanic or Latino: </strong>${item["Anti-Hispanic or Latino"]}</p>`
      ).openPopup()
		})
